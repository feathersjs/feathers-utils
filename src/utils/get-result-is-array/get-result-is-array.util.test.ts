...
describe('getResultIsArray', () => {
  ...
  it('array result', () => {
    ...
    expect(
      getResultIsArray({ method: 'find', result: { data: result } } as any),
    ).toEqual({
      isArray: true,
      result,
      key: 'result',
  ...
  it('dispatch', () => {
    ...
    expect(
      getResultIsArray({ result, dispatch } as any, { dispatch: true }),
    ).toEqual({
      isArray: false,
      result: [dispatch],
      key: 'dispatch',
    ...
    expect(
      getResultIsArray({ method: 'find', result, dispatch } as any, {
        dispatch: true,
      }),
    ).toEqual({
      isArray: false,
    ...
    expect(
      getResultIsArray(
        { method: 'find', result: { data: result }, dispatch } as any,
        {
          dispatch: true,
        },
      ),
